...
public class Car {
    ...
    public static void main(String[] args) {
        ...
        List<Car> orderByPrice=carList.stream().sorted(Comparator.comparingInt(Car::getPrice)).
                collect(Collectors.toList());
        orderByPrice.forEach(System.out::println);

        System.out.println("\nCars order by Year:");
        List<Car> orderByYear=carList.stream().sorted(Comparator.comparingInt(Car::getYear)).
                collect(Collectors.toList());
        orderByYear.forEach(System.out::println);

        System.out.println("\nCars order by Mileage:");
        List<Car> orderByMileage=carList.stream().sorted(Comparator.comparingInt(Car::getMileage)).
                collect(Collectors.toList());
        orderByMileage.forEach(System.out::println);

        System.out.println("\nCars order by Domination rank:");
        List<Car> orderByDomination=carList.stream().sorted(Comparator.comparingInt(Car::getDominationCount)).
                collect(Collectors.toList());
        ...
        System.out.println("\nTotal no. of car makers: "+carMakerNum);
        ...
        int carModelNum = carList.stream()
                ...
                .reduce(0,
                        ...
                        (finalResult,intermediateResult)-> finalResult + intermediateResult);
        System.out.println("Total no. of car models: "+carModelNum);
